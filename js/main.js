		...
		// Preloader
      	...
      	$(window).load(function() {
      		$(".preloader").fadeOut("slow", function(){
				...
				$('.hi .detail')
					.typeTo("I'm Kimani. Full Stack web developer IT-Support Consultant Multi-level Network Marketing. based in Nairobi , Kenya. While not coding, i love to play guitar,Gym  and tone IT and read comic books.");
      		});
		});
